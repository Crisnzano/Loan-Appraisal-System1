 ...
 <div class="full-page">
        ...
        <div id='login-form'class='login-page'>
            <div class="form-box">
                <div class='button-box'>
                    <div id='btn'></div>
                    <a href='complete-login-register-form-with-email-verification-main/index.php'>
                    <button type='button' class='toggle-btn'>Log In</button></a>
                    <a href='complete-login-register-form-with-email-verification-main/register.php'>
        ...
        <div class="display">
                    ...
                    <div class = "links slide-left">
                        <a href="complete-login-register-form-with-email-verification-main/index.php" class="buttons">Apply Now</a>
                        <a href="complete-login-register-form-with-email-verification-main/index.php"> View Loan Details Here</a>
                </div>
        </div>
    </div>
