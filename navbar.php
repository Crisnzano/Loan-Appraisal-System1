...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=borrowers" class="nav-item nav-borrowers"><span class='icon-field'><i class="fa fa-user-friends"></i></span> Clients</a>
				...
				<a href="index.php?page=../Loan-Appraisal-System1/chartjs-project/index.php" class="nav-item nav-home"><span class='icon-field'><i class="fa fa-home"></i></span> Reports</a>
