...
<?php
  ...
  $sql = "CALL `LoanPlanbyRepaymentAmount`($currentYear_top5LoanPlans);";
...
<?php
  ...
  $sql = "CALL `DepositVsGoal`($currentYear_top5LoanPlans);";
  $result = $conn->query($sql);
  ...
  if ($result->num_rows > 0) {
    ...
    // output data of each row
    while($row = $result->fetch_assoc()) {
      $salesRevenue[$row['applicationYear']][$row['applicationMonth']] = $row['expenseRevenue'];
    }
  } else {
    echo "0 results";
  }
...
<div class="col-md-6 my-1">
    ...
    <div class="card-body">
    <strong>
      KPI3a (leading): <u>Loan plan by Repayment Amount</u><br>
...
<div class="col-md-6 my-1">
    ...
    <div class="card-body">
    <strong>
      KPI3b (lagging): <u>Deposit vs Goal</u><br>
...
<script>
      ...
      new Chart(kpi3a, {
        ...
        datasets: [{
          label: 'Loan plan by Repayment Amount',
