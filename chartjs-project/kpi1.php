...
<?php
  ...
  $sql = $sql = "CALL `Top5LoanPlansofTheYear`($currentYear_top5LoanPlans);";
  ...
  if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
      ...
      $loanPercentage[$row['row_num']] = $row['interest_percentage'];
      $fullLoanDetails[$row['row_num']] = $row['fullPlanDetails'];
      $sumRepaymentEach[$row['row_num']] = $row['sumRepaymentEach'];
    }
  } else {
    "0 results";
  }
...
<div class="col-md-6 my-1">
  ...
  <div class="card-body text-center">
    <strong>
      KPI1a (leading): <u>Top 5 Loan plans of the Year</u><br>
...
<div class="col-md-6 my-1">
  ...
  <div class="card-body text-center">
    <strong>
      KPI1b (lagging): <u>Monthly Loan Revenue</u><br>
